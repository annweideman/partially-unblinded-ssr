#-------------------------------------------------------------------------------
# Topic: Plots of type 1 error for output from script sims_t1_error.R
...
plot <- ggplot(results_long, aes(x = n0, y = type_1_error, 
  ...
  scale_y_continuous(limits = c(0, 0.052), breaks = seq(0, 0.052, by = 0.01)) + 
  theme(
...
# Save plot
#ggsave(filename = paste0(script_path, "/output/plot_t1_p00.2_k2.jpg"), 
